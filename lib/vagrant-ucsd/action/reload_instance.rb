    ...
    module Action
      ...
      class ReloadInstance
        ...
        def initialize(app, env)
          @app    = app
          @logger = Log4r::Logger.new("ucsd::action::reload_instance")
        end
        ...
        def call(env)
              ...
              if found == true
                ...
                encoded = URI.encode("https://#{host_ip}/app/api/rest?opName=userAPIExecuteVMAction&opData={param0:\"#{env[:vm_id]}\",param1:\"reboot\", param2:\"\"}");            
